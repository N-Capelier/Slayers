...
/*
 *
 *This script provide functions to use built-in arrays in a more natural way, like an ArrayList.
Usage
To use ArrayTools functions, you need to specify the type of the elements of the array. The modified array is returned by the function.
